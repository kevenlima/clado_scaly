...
phylo_dist <- read.csv("D:/R/a_mantel/new_mantel/distancia_filogenetica_mantel.csv", row.names = 1)
niche_overlap <- read.csv("D:/R/a_mantel/new_mantel/niche_overlap_results_D_NA.csv", row.names = 1)
...
ggsave("01_new_correlacao_D_mantel.png", plot = p, width = 6, height = 6, units = "in", dpi = 300)
...
writeLines(mantel_results, "new_resultados_D_mantel_of.txt")
...
# Save the Mantel test results in a text file
writeLines(mantel_results, "new_resultados_I_mantel_of_02.txt")
